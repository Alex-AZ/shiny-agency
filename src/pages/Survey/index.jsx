  ...
  return (
    <SurveyContainer>
      ...
      {isLoading ? (
        ...
        <QuestionContent>
          {surveyData && surveyData[questionNumber]} {/* Une des manières d’éviter l’erreur (undefined) est de vérifier que surveyData est défini avant de l'utiliser dans le composant grâce aux '&&' */}
        </QuestionContent>
      )}
      <ReplyWrapper>
        <ReplyBox
